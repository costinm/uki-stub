...
func (p *EFI_RUNTIME_SERVICES) GetVariable(VariableName *CHAR16, VendorGuid *EFI_GUID, Attributes *uint32, DataSize *UINTN, Data *VOID) EFI_STATUS {
	return UefiCall5(uintptr(ptrval(&p.getVariable)), uintptr(unsafe.Pointer(VariableName)), uintptr(unsafe.Pointer(VendorGuid)), uintptr(unsafe.Pointer(Attributes)), uintptr(unsafe.Pointer(DataSize)), uintptr(unsafe.Pointer(Data)))
}
...
func (p *EFI_RUNTIME_SERVICES) GetNextVariableName(VariableNameSize *UINTN, VariableName *CHAR16, VendorGuid *EFI_GUID) EFI_STATUS {
	return UefiCall3(uintptr(ptrval(&p.getNextVariableName)), uintptr(unsafe.Pointer(VariableNameSize)), uintptr(unsafe.Pointer(VariableName)), uintptr(unsafe.Pointer(VendorGuid)))
}
